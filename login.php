...
<div class="main-container">
  <div class="login-container">
    ...
    <div class="login-image">
      <div class="quote-box">
        <h2>Welcome to BookCraft</h2>
        <div class="book-divider">
          <span></span>
          <i class="fas fa-book"></i>
          <span></span>
        </div>
        <p>"A reader lives a thousand lives before he dies. The person who never reads lives only one." — George R.R. Martin</p>
      </div>
    </div>
    ...
    <div class="form-side">
      ...
      <div class="login-header">
        ...
        <h3>Sign In</h3>
        <p>Access your BookCraft account</p>
      </div>
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    tl.to('.login-header h3, .login-header p', {
      opacity: 1,
      stagger: 0.2,
      duration: 0.8
    }, '-=0.6');
    ...
    tl.to('.form-options, .submit-btn, .register-text', {
      opacity: 1,
      stagger: 0.2,
      duration: 0.8
    }, '-=0.4');
